<?php 
    ...
    class MAaProcesar{
        ...
        public function buscarMuestraAProcesar($id){
            $peticion = conexion();
            $peticion = $peticion->prepare("SELECT * FROM `muestra_agua_a_procesar` WHERE `IDMuestra_A_Procesar` = '$id';");
            $peticion->execute();
        ...
        public function eliminarMuestraAProcesar($id){
            $peticion = conexion();
            $peticion = $peticion->prepare("DELETE FROM `muestra_agua_a_procesar` WHERE `IDMuestra_A_Procesar` = ".$id.";");
            $peticion->execute();
