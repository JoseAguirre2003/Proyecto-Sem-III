        ...
        if (!$muestras)
            ...
            echo ' 
                        ...
                        <form action="./verProductor.php?buscar=' . $muestras['IDProductor'] . '&idElim=' . $muestras['IDMuestraSuelo'] . '" method="POST">
                            ...
                            <button type="button" class="boton"><a href="reportemps.php?idMuestra=' . $muestras['IDMuestraSuelo'] . '">Reporte</a></button>
                        </form>
                    ';
            ...
            if (!$muestrasAProcesar)
                ...
                echo '      
                            <h3>Click en ID para editar o eliminar</h3>
                            <table id="resultado">
                                <tbody>
                                    <tr>
                ...
                foreach ($muestrasAProcesar as $rowAP) {
                    echo '
                                <tr>
                                    <td id="idMuestraAProcesar"><a href="./verMuestrasAProcesar.php?buscar='.$rowAP['IDMuestra_A_Procesar'].'">' . $rowAP['IDMuestra_A_Procesar'] . '</a></td>
